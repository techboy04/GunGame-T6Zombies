...
CoD.PrivateGameLobby.GunGameOptions = {}
CoD.PrivateGameLobby.GunGameOptions[1] = {}
CoD.PrivateGameLobby.GunGameOptions[1].id = "enable_gungame"
CoD.PrivateGameLobby.GunGameOptions[1].name = "ENABLE GUN GAME"
CoD.PrivateGameLobby.GunGameOptions[1].hintText = "Toggle the gamemode."
CoD.PrivateGameLobby.GunGameOptions[1].labels = {}
CoD.PrivateGameLobby.GunGameOptions[1].labels[1] = "ENABLED"
CoD.PrivateGameLobby.GunGameOptions[1].labels[2] = "DISABLED"
CoD.PrivateGameLobby.GunGameOptions[1].values = {}
CoD.PrivateGameLobby.GunGameOptions[1].values[1] = 1
CoD.PrivateGameLobby.GunGameOptions[1].values[2] = 0
CoD.PrivateGameLobby.GunGameOptions[1].maps = {}
CoD.PrivateGameLobby.GunGameOptions[1].maps[1] = "zm_transit"
CoD.PrivateGameLobby.GunGameOptions[1].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.GunGameOptions[1].maps[3] = "zm_buried"
CoD.PrivateGameLobby.GunGameOptions[1].maps[4] = "zm_prison"
CoD.PrivateGameLobby.GunGameOptions[1].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.GunGameOptions[1].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.GunGameOptions[1].gameTypes = {}
CoD.PrivateGameLobby.GunGameOptions[1].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.GunGameOptions[1].gameTypes[2] = "zstandard"

CoD.PrivateGameLobby.GunGameOptions[2] = {}
CoD.PrivateGameLobby.GunGameOptions[2].id = "gungame_ladder"
CoD.PrivateGameLobby.GunGameOptions[2].name = "GUN LADDER"
CoD.PrivateGameLobby.GunGameOptions[2].hintText = "The list of weapons that will be used in the mode."
CoD.PrivateGameLobby.GunGameOptions[2].labels = {}
CoD.PrivateGameLobby.GunGameOptions[2].labels[1] = "REGULAR GUNS"
CoD.PrivateGameLobby.GunGameOptions[2].labels[2] = "REGULAR + PAP"
CoD.PrivateGameLobby.GunGameOptions[2].labels[3] = "REGULAR RANDOMIZED"
CoD.PrivateGameLobby.GunGameOptions[2].labels[4] = "REGULAR + PAP RANDOMIZED"
CoD.PrivateGameLobby.GunGameOptions[2].values = {}
CoD.PrivateGameLobby.GunGameOptions[2].values[1] = 0
CoD.PrivateGameLobby.GunGameOptions[2].values[2] = 1
CoD.PrivateGameLobby.GunGameOptions[2].values[3] = 2
CoD.PrivateGameLobby.GunGameOptions[2].values[4] = 3
CoD.PrivateGameLobby.GunGameOptions[2].maps = {}
CoD.PrivateGameLobby.GunGameOptions[2].maps[1] = "zm_transit"
CoD.PrivateGameLobby.GunGameOptions[2].maps[2] = "zm_highrise"
CoD.PrivateGameLobby.GunGameOptions[2].maps[3] = "zm_buried"
CoD.PrivateGameLobby.GunGameOptions[2].maps[4] = "zm_prison"
CoD.PrivateGameLobby.GunGameOptions[2].maps[5] = "zm_nuked"
CoD.PrivateGameLobby.GunGameOptions[2].maps[6] = "zm_tomb"
CoD.PrivateGameLobby.GunGameOptions[2].gameTypes = {}
CoD.PrivateGameLobby.GunGameOptions[2].gameTypes[1] = "zclassic"
CoD.PrivateGameLobby.GunGameOptions[2].gameTypes[2] = "zstandard"
...
CoD.PrivateGameLobby.PopulateButtons_Project_Zombie = function (PrivateGameLobbyButtonPane, IsHost)
	if IsHost == true then
		...
		-- 	PrivateGameLobbyButtonPane.body.widestButtonTextWidth = f9_local1_3
		-- end
		AddGameOptionsButtons(PrivateGameLobbyButtonPane, CoD.PrivateGameLobby.GunGameOptions, "dvar")
